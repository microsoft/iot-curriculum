...
In this lab we will send a manual message to a device and we will show an example piece of code that can react to downstream cloud to device messages. Extending this capability for more complex in-device behaviors would be the logical next step
...
```sh
python3 iot-client/iot-hub-client-message.py "YOUR_DEVICE_CONNECTION_STRING_NOT_THIS_TEXT_PLACEHOLDER"
```
...
Take a look at the python3 [script](https://github.com/microsoft/iot-curriculum/blob/main/labs/iot/hands-on-with-azure-iot-hub/iot-client/iot-hub-client-message.py) and analyze how bidirectional message communication works.
